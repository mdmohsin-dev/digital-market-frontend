...
export default function CheckoutClient() {
    ...
    const handlePromo = () => {
        ...
        if (subtotal < coupon.minimumOrder) {
            ...
            setAppliedCoupon(null);
            setPromoError(
                `Minimum order of ৳${coupon.minimumOrder.toLocaleString()} is required.`,
            );
            return;
        }
                    ...
                    <div className="mt-6 rounded-md border border-primary/20 bg-primary/5 p-3">
                        ...
                        <div className="mt-3 flex gap-2">
                            ...
                            <input
                                ...
                                className={`h-10 min-w-0 flex-1 rounded-md border bg-white px-3 text-sm uppercase outline-none focus:border-primary ${
                                    promoError
                                        ? "border-red-400"
                                        : "border-gray-300"
                                }`}
                            ...
                            {promoApplied ? (
                                <button
                                    ...
                                    className="h-10 rounded-md border border-gray-300 bg-white px-4 text-sm font-medium text-gray-700 transition hover:border-red-300 hover:text-red-500"
                                >
                                    Remove
                                </button>
                            ) : (
